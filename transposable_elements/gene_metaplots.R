...
### plot DIFFERENCE from regular median
metaplotmelt$mindndsvalue=metaplotmindndsmelt$value[match(paste(metaplotmelt$window, metaplotmelt$variable), paste(metaplotmindndsmelt$window, metaplotmindndsmelt$variable))]
metaplotmelt$maxdndsvalue=metaplotmaxdndsmelt$value[match(paste(metaplotmelt$window, metaplotmelt$variable), paste(metaplotmaxdndsmelt$window, metaplotmaxdndsmelt$variable))]

ggplot(metaplotmelt[metaplotmelt$ploidy!='Diploid',], aes(group=variable, x=window, y=mindndsvalue-value, color=ploidy))+ geom_vline(xintercept=c(1,1:(((flankspace*2)+2000)/1000)*10), color='whitesmoke') + geom_line(alpha=0.7) + scale_color_manual(values=ploidycolors)  + xlab('Base pairs away from TSS/TTS') + ylab('min dnds genes - all genes, Median TE base pairs in 100bp window') + geom_vline(xintercept=c(flankspace/100, (flankspace/100)+10, (flankspace/100)+20), lty=c('dashed', 'solid', 'dashed')) + scale_x_continuous(breaks=c(1, flankspace/100, (flankspace/100)+10, (flankspace/100)+20, ((flankspace*2)+2000)/100), labels=c(paste0('-', flankspace), 'TranslationSS', 'X', 'TranslTermS', paste0('+', flankspace)))  + theme(axis.text.x=element_text(angle=20,hjust=1))
ggplot(metaplotmelt[metaplotmelt$ploidy!='Diploid',], aes(group=variable, x=window, y=maxdndsvalue-value, color=ploidy))+ geom_vline(xintercept=c(1,1:(((flankspace*2)+2000)/1000)*10), color='whitesmoke') + geom_line(alpha=0.7) + scale_color_manual(values=ploidycolors)  + xlab('Base pairs away from TSS/TTS') + ylab('max dnds genes - all genes, Median TE base pairs in 100bp window') + geom_vline(xintercept=c(flankspace/100, (flankspace/100)+10, (flankspace/100)+20), lty=c('dashed', 'solid', 'dashed')) + scale_x_continuous(breaks=c(1, flankspace/100, (flankspace/100)+10, (flankspace/100)+20, ((flankspace*2)+2000)/100), labels=c(paste0('-', flankspace), 'TranslationSS', 'X', 'TranslTermS', paste0('+', flankspace)))  + theme(axis.text.x=element_text(angle=20,hjust=1))

ggplot(metaplotmelt[metaplotmelt$ploidy!='Diploid',], aes(group=variable, x=window, y=mindndsvalue-value, color=ploidy))+ geom_vline(xintercept=c(1,1:(((flankspace*2)+2000)/1000)*10), color='whitesmoke') + geom_line(alpha=0.7) + scale_color_manual(values=ploidycolors)  + xlab('Base pairs away from TSS/TTS') + ylab('min dnds genes - all genes, Median TE base pairs in 100bp window') + geom_vline(xintercept=c(flankspace/100, (flankspace/100)+10, (flankspace/100)+20), lty=c('dashed', 'solid', 'dashed')) + scale_x_continuous(breaks=c(1, flankspace/100, (flankspace/100)+10, (flankspace/100)+20, ((flankspace*2)+2000)/100), labels=c(paste0('-', flankspace), 'TranslationSS', 'X', 'TranslTermS', paste0('+', flankspace)))  + theme(axis.text.x=element_text(angle=20,hjust=1)) + 
  geom_text_repel(aes(label = variable), data = metaplotmelt[metaplotmelt$window==((flankspace*2)+2000)/100 & metaplotmelt$ploidy!='Diploid',], size = 3, max.overlaps=Inf) +
  geom_text_repel(aes(label = variable), data = metaplotmelt[metaplotmelt$window==1 & metaplotmelt$ploidy!='Diploid',], size = 3, max.overlaps=Inf)
ggplot(metaplotmelt[metaplotmelt$ploidy!='Diploid',], aes(group=variable, x=window, y=maxdndsvalue-value, color=ploidy))+ geom_vline(xintercept=c(1,1:(((flankspace*2)+2000)/1000)*10), color='whitesmoke') + geom_line(alpha=0.7) + scale_color_manual(values=ploidycolors)  + xlab('Base pairs away from TSS/TTS') + ylab('max dnds genes - all genes, Median TE base pairs in 100bp window') + geom_vline(xintercept=c(flankspace/100, (flankspace/100)+10, (flankspace/100)+20), lty=c('dashed', 'solid', 'dashed')) + scale_x_continuous(breaks=c(1, flankspace/100, (flankspace/100)+10, (flankspace/100)+20, ((flankspace*2)+2000)/100), labels=c(paste0('-', flankspace), 'TranslationSS', 'X', 'TranslTermS', paste0('+', flankspace)))  + theme(axis.text.x=element_text(angle=20,hjust=1)) + 
  geom_text_repel(aes(label = variable), data = metaplotmelt[metaplotmelt$window==((flankspace*2)+2000)/100 & metaplotmelt$ploidy!='Diploid',], size = 3, max.overlaps=Inf) +
  geom_text_repel(aes(label = variable), data = metaplotmelt[metaplotmelt$window==1 & metaplotmelt$ploidy!='Diploid',], size = 3, max.overlaps=Inf)
