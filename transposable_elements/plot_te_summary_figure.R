...
helsynt=ggplot(gg[gg$sup=='DHH',], aes(x=doubledValue/2, y=synteniccount, color=ploidy)) +  geom_point() + 
...
summary(lm(gg$synteniccount[gg$sup=='DHH']~gg$doubledValue[gg$sup=='DHH']))
summary(lm(gg$synteniccount[gg$sup=='DHH' & gg$ploidy!='Paleotetraploid']~gg$doubledValue[gg$sup=='DHH' & gg$ploidy!='Paleotetraploid']))
summary(lm(gg$doubledgenecount[gg$sup=='DHH']~gg$doubledValue[gg$sup=='DHH'] + gg$synteniccount[gg$sup=='DHH']))


syntannot=ggplot(gg[gg$sup=='DHH',], aes(x=doubledgenecount/2, y=synteniccount, color=ploidy)) +  geom_point() + 
                                      scale_color_manual(values=ploidycolors, name='Ploidy') + xlab('Total Haploid\nSyntenic Gene Count') + ylab('Total Haploid Gene Count') +theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
...
bottomlayer=plot_grid(dtt + theme(legend.position='NULL'), dttfam + theme(legend.position='NULL'), helitron + theme(legend.position='NULL'), helgene + theme(legend.position='NULL'), 
                      legend, align='hv', nrow=1,rel_widths=c(1,1,1,1,1,0.4),labels=c('g', 'h', 'i', 'j', ''))
