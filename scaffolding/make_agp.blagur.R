...
hcontochr=c('scaf_1', 'scaf_2', 'scaf_3', 'scaf_5', #chr1 - one fusion, one unclear
            'scaf_4', 'scaf_7', 'scaf_6',#chr2
            'scaf_9', 'scaf_10', 'scaf_11', 'alt-scaf_12',#chr3
            'scaf_13', 'scaf_14', 'scaf_15','scaf_19', 'scaf_20',#chr4
            'scaf_22',#chr5
            'alt-scaf_17', 'scaf_16', 'scaf_18', 'scaf_21',#chr6
            'scaf_27', 'scaf_28',#chr7
 #           ,#chr8
            'scaf_23',#chr9
            'scaf_24'# chr10
            )
...
#      current_start <- current_start + contig_length ### DO NOT DO THIS! THIS CHROMOSOME IS FINISHED?!!!
  ...
  chr_partial <- filter(partial_scaffolds, Chr == chr)%>%arrange(start_gene)
