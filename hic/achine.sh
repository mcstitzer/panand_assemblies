...
hicR1=AV9240005_Andropogon_chinensis_HiC_pairsR1.fq.gz
hicR2=AV9240005_Andropogon_chinensis_HiC_pairsR2.fq.gz
six=achine
...
samtools bam2fq -@ 64 ../../../panand_snps/input/achine_reads_withQ.bam > ${six}_hifi.fastq
