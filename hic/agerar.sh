...
hicR1=AV9240006_Andropogon_gerardi_HiC_pairsR1.fq.gz
hicR2=AV9240006_Andropogon_gerardi_HiC_pairsR2.fq.gz
six=agerar
...
### this path is wrong fix it!!!!
#scp cbsublfs1:/data4/Incoming/IowaStateU/rawdata_cinta_2024-08-08/Andropogon_gerardii_CAM1351.CELL01.hifi.bam .
#scp cbsublfs1:/data4/Incoming/IowaStateU/rawdata_cinta_2024-08-08/Andropogon_gerardii_CAM1351.CELL02.hifi.bam .
### NO THESE FILES ARE WRONG!!! WAIT FOR CINTA
# scp cbsublfs1:/data4/Incoming/IowaStateU/rawdata_cinta_2024-06-07/agerardi/Andropogon_gerardii_CAM1351-03.merged.hifi.bam .
# scp cbsublfs1:/data4/Incoming/IowaStateU/rawdata_cinta_2024-06-07/agerardi/Andropogon_gerardii_CAM1351-04.merged.hifi.bam .


## okay cinta agreed - get these from dir they were moved to

scp cbsublfs1:/data3/PanAnd3/RawSeqData/Pacbio/andropogoneae/Andropogon_gerardii/Andropogon_gerardii_CAM1351.CELL01.hifi.bam .
scp cbsublfs1:/data3/PanAnd3/RawSeqData/Pacbio/andropogoneae/Andropogon_gerardii/Andropogon_gerardii_CAM1351.CELL02.hifi.bam .
scp cbsublfs1:/data3/PanAnd3/RawSeqData/Pacbio/andropogoneae/Andropogon_gerardii/Andropogon_gerardii_CAM1351.CELL03.hifi.bam .
scp cbsublfs1:/data3/PanAnd3/RawSeqData/Pacbio/andropogoneae/Andropogon_gerardii/Andropogon_gerardii_CAM1351.CELL04.hifi.bam .

rm ${six}_hifi.fastq
samtools bam2fq -@ 64 Andropogon_gerardii_CAM1351.CELL01.hifi.bam >> ${six}_hifi.fastq 
samtools bam2fq -@ 64 Andropogon_gerardii_CAM1351.CELL02.hifi.bam >> ${six}_hifi.fastq 
samtools bam2fq -@ 64 Andropogon_gerardii_CAM1351.CELL03.hifi.bam >> ${six}_hifi.fastq 
samtools bam2fq -@ 64 Andropogon_gerardii_CAM1351.CELL04.hifi.bam >> ${six}_hifi.fastq 

rm Andropogon_gerardii_CAM1351.CELL01.hifi.bam
rm Andropogon_gerardii_CAM1351.CELL02.hifi.bam
rm Andropogon_gerardii_CAM1351.CELL03.hifi.bam
rm Andropogon_gerardii_CAM1351.CELL04.hifi.bam
...
## is the virgi ancestry making filtering a disaster>?
