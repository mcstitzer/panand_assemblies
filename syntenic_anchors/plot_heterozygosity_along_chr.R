...
tdhet=read.table('~/Downloads/zTIL25chr_snp_summary_100kb.bed') %>% group_by(V1)%>% mutate(max=max(V3))
ggplot(tdhet[tdhet$max>10e6,], aes(x=V2, y=V4/100000)) + geom_point(alpha=0.2) + facet_wrap(~V1, ncol = 2)
...
tdhet=read.table('~/Downloads/zTIL18chr_snp_summary_100kb.bed') %>% group_by(V1)%>% mutate(max=max(V3))
ggplot(tdhet[tdhet$max>10e6,], aes(x=V2, y=V4/100000)) + geom_point(alpha=0.2) + facet_wrap(~V1, ncol = 2)

cents=fread(cmd='grep -E "156bp_repeat|155bp_repeat" ~/Downloads/repeatmask_tandems/Zx-TIL18-REFERENCE-PanAnd-1.0_EDTA.gff3')
knobs=fread(cmd='grep -E "179bp_repeat|180bp_repeat" ~/Downloads/repeatmask_tandems/Zx-TIL18-REFERENCE-PanAnd-1.0_EDTA.gff3')
...
tdhet=read.table('~/Downloads/TIL01chr_snp_summary_100kb.bed') %>% group_by(V1)%>% mutate(max=max(V3))
ggplot(tdhet[tdhet$max>10e6,], aes(x=V2, y=V4/100000)) + geom_point(alpha=0.2) + facet_wrap(~V1, ncol = 2)

cents=fread(cmd='grep -E "156bp_repeat|155bp_repeat" ~/Downloads/repeatmask_tandems/Zv-TIL01-REFERENCE-PanAnd-1.0_EDTAandTandemRepeat.gff3')
knobs=fread(cmd='grep -E "179bp_repeat|180bp_repeat" ~/Downloads/repeatmask_tandems/Zv-TIL01-REFERENCE-PanAnd-1.0_EDTAandTandemRepeat.gff3')
...
tdhet=read.table('~/Downloads/zdgigichr_snp_summary_100kb.bed') %>% group_by(V1)%>% mutate(max=max(V3))
ggplot(tdhet[tdhet$max>10e6,], aes(x=V2, y=V4/100000)) + geom_point(alpha=0.2) + facet_wrap(~V1, ncol = 2)

cents=fread(cmd='grep -E "156bp_repeat|155bp_repeat" ~/Downloads/repeatmask_tandems/Zd-Gigi-REFERENCE-PanAnd-1.0_EDTAandTandemRepeat.gff3')
knobs=fread(cmd='grep -E "179bp_repeat|180bp_repeat" ~/Downloads/repeatmask_tandems/Zd-Gigi-REFERENCE-PanAnd-1.0_EDTAandTandemRepeat.gff3')
...
ggplot(tdhet[substr(tdhet$V1,1,3)=='chr',], aes(x=V2, y=V4/100000)) + geom_point(alpha=0.2) + facet_wrap(~factor(V1, levels=paste0('chr', c(1:10))), ncol = 2) + geom_rect(data=cents_extended, aes(x=V4, y=0,xmin=V4, xmax=V5, ymin=-Inf, ymax=Inf), fill='darkblue', alpha=0.9)+ geom_rect(data=knobs_extended, aes(x=V4, y=0,xmin=V4, xmax=V5, ymin=-Inf, ymax=Inf), fill='darkgreen', alpha=0.3)  + ylab('Heterozygosity') + xlab('Z. diploperennis Gigi') 
## plot 0s for jeff
ggplot(tdhet[substr(tdhet$V1,1,3)=='chr',], aes(x=V2, y=V4/100000, color=V4==0)) + geom_point(alpha=0.2) + scale_color_manual(values=c('black', 'red'))+ facet_wrap(~factor(V1, levels=paste0('chr', c(1:18))), ncol = 2) + geom_rect(data=cents_extended, aes(x=V4, y=0,xmin=V4, xmax=V5, ymin=-Inf, ymax=Inf), color=NA, fill='darkblue', alpha=0.9)+ geom_rect(data=knobs_extended, color=NA, aes(x=V4, y=0,xmin=V4, xmax=V5, ymin=-Inf, ymax=Inf), fill='darkgreen', alpha=0.3)  + ylab('Heterozygosity') + xlab('Z. m. subsp. mexicana TIL25') + theme(legend.position='NULL')
