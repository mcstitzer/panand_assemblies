...
then
raxmlHPC-PTHREADS-AVX -T 6 -m GTRGAMMA -p 12345 -x 12345 -# 100 -f a -s aligned/${gene}.aln.fa -n ${gene} -w /project/buckler_lab_panand/michelle.stitzer/panand_assemblies/gene_trees/trees/
