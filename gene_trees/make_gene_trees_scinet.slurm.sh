...
if [ ! -f ${gene}.withPvCDS.aln.fa ]
then
mafft --genafpair --maxiterate 1000 --adjustdirection ${gene}.fa > ${gene}.withPvCDS.aln.fa
sed -i 's/()//g' ${gene}.withPvCDS.aln.fa
sed -i 's/_R_//g' ${gene}.withPvCDS.aln.fa
